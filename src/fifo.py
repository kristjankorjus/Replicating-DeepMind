...
###############
#This little script shows how to initialize communication with ALE and send commands to move left and right in Breakout game.
#Author: Ardi Tampuu
###############
...
#first thing we send to ALE is the output options- we want to get olny image data (hence the zeros)
fout.write("1,0,0,0\n")
...
#first command has to be 1,0 or 1,1, because the game starts not when you press "right" or "left", but whn you press "fire"(space or enter or whatever)
fout.write("1,1\n")
fout.flush()
...
fout.write("3,0\n") #"go right" -> doin it only once stops moving left 
fout.flush()
img= fin.readline()[:-2]
